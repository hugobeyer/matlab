...
#include "MaterialLabEffect.generated.h"
...
class MATERIALLABRUNTIME_API UMaterialLabEffect final : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, AssetRegistrySearchable, Category = "Identity")
	EMaterialLabEffectType EffectType = EMaterialLabEffectType::Peeling;
