...
namespace MixtormatUI
{
	...
	const TCHAR* PackedMapLabel(const UMixtormatSurface& Surface)
	{
	...
	FText HeightBlendSourceText(const UMixtormatSurface* Surface)
	{
	...
	void ValidateHeightReferences(TArray<FMixtormatLayer>& Layers)
	{
	...
	void RemapHeightReferencesAfterInsert(TArray<FMixtormatLayer>& Layers, const int32 InsertIndex)
	{
	...
	void RemapHeightReferencesAfterDelete(TArray<FMixtormatLayer>& Layers, const int32 DeletedIndex)
	{
		for (FMixtormatLayer& Layer : Layers)
		{
	...
	FText MaskBlendModeText(const EMixtormatMaskBlendMode Mode)
	{
		switch (Mode)
		{
		...
		[
			...
			[
				...
				[
					...
					.BorderImage(FMixtormatStyle::Get().GetBrush(TEXT("Mixtormat.InspectorGroupHeader")))
					[Header]
				]
				+ SVerticalBox::Slot().AutoHeight()
				[
...
class SMixtormatNumericResetBox final : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SMixtormatNumericResetBox) {}
...
TSharedRef<SWidget> SMixtormat::MakeResettableNumeric(
	...
	const FSimpleDelegate& ResetDelegate)
{
	...
	TSharedRef<SMixtormatNumericResetBox> ResetBox =
		SNew(SMixtormatNumericResetBox)
...
TSharedRef<SWidget> SMixtormat::BuildPreviewPanel()
{
	...
	TSharedRef<SHorizontalBox> FovControls = SNew(SHorizontalBox)
		...
		[
			...
			[
				SNew(SSlider)
				.Style(&FMixtormatStyle::Get().GetWidgetStyle<FSliderStyle>(TEXT("Mixtormat.ScrubSlider")))
		...
		[
			...
			.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
			.AllowSpin(true)
			.MinValue(20.0f)
			.MaxValue(90.0f)
	...
	return SNew(SBox)
		...
		[
			...
			[
				...
				[
					SNew(STextBlock)
					.Text(LOCTEXT("ProcPeelHint", "The ordered child mask seeds the peel: threshold it with Mask Gain and Amount. Convexity, occlusion and height then set how fast the front spreads from those seeds. Front, Width, Thickness and Lift shape the result in the Peeling section."))
					.AutoWrapText(true)
					.ColorAndOpacity(FSlateColor::UseSubduedForeground())
				]
				...
				[
					...
					[
						...
						.IsChecked_Lambda([this]() { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E && E->PeelType == EMixtormatPeelType::Curled ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; })
						.OnCheckStateChanged_Lambda([this](const ECheckBoxState S) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelType = S == ECheckBoxState::Checked ? EMixtormatPeelType::Curled : EMixtormatPeelType::Flat; RefreshLayeredPreview(); } })
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						SNew(SCheckBox)
						.IsChecked_Lambda([this]() { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E && E->bPeelNormalizeSeedWeights ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; })
						.OnCheckStateChanged_Lambda([this](const ECheckBoxState S) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->bPeelNormalizeSeedWeights = S == ECheckBoxState::Checked; RefreshLayeredPreview(); } })
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelRandomSeed : 1; })
							.OnValueChanged_Lambda([this](const int32 V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelRandomSeed = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && E->PeelRandomSeed != 1) { E->PeelRandomSeed = 1; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelSeedThreshold : 0.62f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelSeedThreshold = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelSeedThreshold, 0.62f)) { E->PeelSeedThreshold = 0.62f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelCurvW", "Growth · Convexity"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<float>)
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelSeedCurvatureWeight : 0.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelSeedCurvatureWeight = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelSeedCurvatureWeight, 0.0f)) { E->PeelSeedCurvatureWeight = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelSeedCurvatureBias : 1.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelSeedCurvatureBias = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelSeedCurvatureBias, 1.0f)) { E->PeelSeedCurvatureBias = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelAOW", "Growth · Occlusion"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<float>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(-2.0f).MaxSliderValue(2.0f).Delta(0.02f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelSeedAOWeight : 0.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelSeedAOWeight = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelSeedAOWeight, 0.0f)) { E->PeelSeedAOWeight = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelHeightW", "Growth · Height"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<float>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(-2.0f).MaxSliderValue(2.0f).Delta(0.02f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelSeedHeightWeight : 0.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelSeedHeightWeight = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelSeedHeightWeight, 0.0f)) { E->PeelSeedHeightWeight = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelMaskSlot", "Peel Mask"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						SNew(SComboButton)
						...
						.OnGetMenuContent_Lambda([this]()
						{
							...
							Menu.AddMenuEntry(
								LOCTEXT("PPeelMaskClear", "Child Mask (none)"),
								LOCTEXT("PPeelMaskClearHint", "Fall back to the layer's accumulated child mask."),
								FSlateIcon(),
							...
							Menu.BeginSection(NAME_None, LOCTEXT("PPeelMaskSection", "Masks"));
				...
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelMaskTiling", "Peel Mask Tiling"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<int32>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(1).MaxSliderValue(16).Delta(1).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelMaskTiling : 1; })
							.OnValueChanged_Lambda([this](const int32 V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelMaskTiling = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && E->PeelMaskTiling != 1) { E->PeelMaskTiling = 1; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelMaskInv", "Peel Mask Invert"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						SNew(SCheckBox)
						.IsChecked_Lambda([this]() { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E && E->bPeelMaskInvert ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; })
						.OnCheckStateChanged_Lambda([this](const ECheckBoxState S) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->bPeelMaskInvert = S == ECheckBoxState::Checked; RefreshLayeredPreview(); } })
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelMaskW", "Seed · Mask Gain"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<float>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(-2.0f).MaxSliderValue(2.0f).Delta(0.02f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelSeedMaskWeight : 0.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelSeedMaskWeight = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelSeedMaskWeight, 0.0f)) { E->PeelSeedMaskWeight = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelCurvatureRadius : 2; })
							.OnValueChanged_Lambda([this](const int32 V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelCurvatureRadius = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && E->PeelCurvatureRadius != 2) { E->PeelCurvatureRadius = 2; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelGrowth", "Growth Strength"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<float>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(0.0f).MaxSliderValue(4.0f).Delta(0.02f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelGrowthStrength : 1.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelGrowthStrength = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelGrowthStrength, 1.0f)) { E->PeelGrowthStrength = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelAO", "Contact AO"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<float>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(0.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelAOStrength : 0.8f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelAOStrength = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelAOStrength, 0.8f)) { E->PeelAOStrength = 0.8f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelSharp", "Edge Sharpness"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<float>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(0.05f).MaxSliderValue(8.0f).Delta(0.05f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelEdgeSharpness : 1.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelEdgeSharpness = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelEdgeSharpness, 1.0f)) { E->PeelEdgeSharpness = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelLiftVar", "Lift Variation"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<float>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(0.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelLiftVariation : 0.6f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelLiftVariation = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelLiftVariation, 0.6f)) { E->PeelLiftVariation = 0.6f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelSizeVar", "Size Variation"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<float>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(0.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelSizeVariation : 0.5f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelSizeVariation = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && !FMath::IsNearlyEqual(E->PeelSizeVariation, 0.5f)) { E->PeelSizeVariation = 0.5f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelClusterP", "Flake Cells"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<int32>)
							...
							.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelClusterPeriod : 4; })
							.OnValueChanged_Lambda([this](const int32 V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelClusterPeriod = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && E->PeelClusterPeriod != 4) { E->PeelClusterPeriod = 4; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					SNew(SHorizontalBox)
					+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)[SNew(STextBlock).Text(LOCTEXT("PPeelSolveDiv", "Solve Scale"))]
					+ SHorizontalBox::Slot().AutoWidth()
					[
						MakeResettableNumeric(
							SNew(SNumericEntryBox<int32>)
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(1).MaxSliderValue(8).Delta(1).MinDesiredValueWidth(96.0f)
							.ToolTipText(LOCTEXT("PPeelSolveDivHint", "Divides the resolution the front is solved at. Higher is much cheaper; 1 solves at full composition resolution."))
							.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); return E ? E->PeelSolveDivisor : 4; })
							.OnValueChanged_Lambda([this](const int32 V) { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel()) { E->PeelSolveDivisor = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedProceduralPeel(); E && E->PeelSolveDivisor != 4) { E->PeelSolveDivisor = 4; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 4.0f)
			]
			...
			[
				...
				[
					...
					[
						...
						.IsChecked_Lambda([this]() { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E && E->ErosionDirectionMode == EMixtormatErosionDirectionMode::Lerp ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; })
						.OnCheckStateChanged_Lambda([this](const ECheckBoxState S) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionDirectionMode = S == ECheckBoxState::Checked ? EMixtormatErosionDirectionMode::Lerp : EMixtormatErosionDirectionMode::Weight; RefreshLayeredPreview(); } })
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(0.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionAmount : 1.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionAmount = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionAmount, 1.0f)) { E->ErosionAmount = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionRepose : 0.30f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionRepose = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionRepose, 0.30f)) { E->ErosionRepose = 0.30f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(0.0f).MaxSliderValue(32.0f).Delta(0.05f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionReposeSoftness : 0.25f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionReposeSoftness = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionReposeSoftness, 0.25f)) { E->ErosionReposeSoftness = 0.25f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(1).MaxSliderValue(32).Delta(1).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionSlopeRadius : 2; })
							.OnValueChanged_Lambda([this](const int32 V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionSlopeRadius = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && E->ErosionSlopeRadius != 2) { E->ErosionSlopeRadius = 2; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionSlopeBlur : 2.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionSlopeBlur = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionSlopeBlur, 2.0f)) { E->ErosionSlopeBlur = 2.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionCavityBias : 0.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionCavityBias = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionCavityBias, 0.0f)) { E->ErosionCavityBias = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionCavityScale : 1.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionCavityScale = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionCavityScale, 1.0f)) { E->ErosionCavityScale = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(-16.0f).MaxSliderValue(16.0f).Delta(0.05f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionHeightInfluence : 0.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionHeightInfluence = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionHeightInfluence, 0.0f)) { E->ErosionHeightInfluence = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(0.0f).MaxSliderValue(32.0f).Delta(0.1f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionHeightScale : 1.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionHeightScale = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionHeightScale, 1.0f)) { E->ErosionHeightScale = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionGullyWeight : 2.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionGullyWeight = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionGullyWeight, 2.0f)) { E->ErosionGullyWeight = 2.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinSliderValue(0.0f).MaxSliderValue(32.0f).Delta(0.1f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionNormalStrength : 8.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionNormalStrength = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionNormalStrength, 8.0f)) { E->ErosionNormalStrength = 8.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionBlendSoftness : 0.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionBlendSoftness = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionBlendSoftness, 0.0f)) { E->ErosionBlendSoftness = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionDirectionAngle : 90.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionDirectionAngle = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionDirectionAngle, 90.0f)) { E->ErosionDirectionAngle = 90.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatLayerEffect* E = GetSelectedErosion(); return E ? E->ErosionDirectionAmount : 0.0f; })
							.OnValueChanged_Lambda([this](const float V) { if (FMixtormatLayerEffect* E = GetSelectedErosion()) { E->ErosionDirectionAmount = V; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatLayerEffect* E = GetSelectedErosion(); E && !FMath::IsNearlyEqual(E->ErosionDirectionAmount, 0.0f)) { E->ErosionDirectionAmount = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
			]
		];
		...
		[
			...
			.HeaderAction(
				...
				[
					...
					.IsChecked_Lambda([this]() { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen && Gen->bEnabled ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; })
					.OnCheckStateChanged_Lambda([this](const ECheckBoxState State) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->bEnabled = State == ECheckBoxState::Checked; RefreshLayeredPreview(); RebuildLayerList(); } })
				])
			[
				SNew(SVerticalBox)
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 4.0f)
				...
				[
					...
					[
						SNew(SComboButton)
						.ButtonContent()[SNew(STextBlock).Text_Lambda([this]() { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? MixtormatUI::MaskBlendModeText(Gen->BlendMode) : FText::GetEmpty(); })]
				...
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->CurvatureWeight : 0.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->CurvatureWeight = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->CurvatureWeight, 0.0f)) { Gen->CurvatureWeight = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->CurvatureBias : 0.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->CurvatureBias = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->CurvatureBias, 0.0f)) { Gen->CurvatureBias = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->CurvatureStrength : 4.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->CurvatureStrength = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->CurvatureStrength, 4.0f)) { Gen->CurvatureStrength = 4.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->CurvaturePower : 1.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->CurvaturePower = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->CurvaturePower, 1.0f)) { Gen->CurvaturePower = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinValue(-8.0f).MaxValue(8.0f).MinSliderValue(-1.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->DirectionWeight : 0.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->DirectionWeight = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->DirectionWeight, 0.0f)) { Gen->DirectionWeight = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->DirectionAngle : 90.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->DirectionAngle = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->DirectionAngle, 90.0f)) { Gen->DirectionAngle = 90.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->DirectionBroadness : 1.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->DirectionBroadness = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->DirectionBroadness, 1.0f)) { Gen->DirectionBroadness = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinValue(-8.0f).MaxValue(8.0f).MinSliderValue(-1.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->AOWeight : 0.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->AOWeight = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->AOWeight, 0.0f)) { Gen->AOWeight = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinValue(-8.0f).MaxValue(8.0f).MinSliderValue(-1.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->HeightWeight : 0.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->HeightWeight = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->HeightWeight, 0.0f)) { Gen->HeightWeight = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinValue(-8.0f).MaxValue(8.0f).MinSliderValue(-1.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->HeightBias : 0.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->HeightBias = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->HeightBias, 0.0f)) { Gen->HeightBias = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 6.0f, 0.0f, 3.0f)
				...
				[
					...
					[
						SNew(SCheckBox)
						.IsChecked_Lambda([this]() { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen && Gen->bNormalizeWeights ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; })
						.OnCheckStateChanged_Lambda([this](const ECheckBoxState State) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->bNormalizeWeights = State == ECheckBoxState::Checked; RefreshLayeredPreview(); } })
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->Broadness : 2; })
							.OnValueChanged_Lambda([this](const int32 Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->Broadness = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && Gen->Broadness != 2) { Gen->Broadness = 2; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->Smoothing : 2; })
							.OnValueChanged_Lambda([this](const int32 Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->Smoothing = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && Gen->Smoothing != 2) { Gen->Smoothing = 2; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->Bias : 0.5f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->Bias = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->Bias, 0.5f)) { Gen->Bias = 0.5f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->WarpAmount : 0.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->WarpAmount = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->WarpAmount, 0.0f)) { Gen->WarpAmount = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->WarpSource : 0.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->WarpSource = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->WarpSource, 0.0f)) { Gen->WarpSource = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->WarpRadius : 1; })
							.OnValueChanged_Lambda([this](const int32 Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->WarpRadius = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && Gen->WarpRadius != 1) { Gen->WarpRadius = 1; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 6.0f, 0.0f, 3.0f)
				...
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->Weight : 1.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->Weight = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->Weight, 1.0f)) { Gen->Weight = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						SNew(SCheckBox)
						.IsChecked_Lambda([this]() { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen && Gen->bInvert ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; })
						.OnCheckStateChanged_Lambda([this](const ECheckBoxState State) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->bInvert = State == ECheckBoxState::Checked; RefreshLayeredPreview(); } })
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->Balance : 0.5f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->Balance = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->Balance, 0.5f)) { Gen->Balance = 0.5f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->Contrast : 1.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->Contrast = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->Contrast, 1.0f)) { Gen->Contrast = 1.0f; RefreshLayeredPreview(); } }))
					]
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					...
					[
						MakeResettableNumeric(
							...
							.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
							.AllowSpin(true).MinValue(-8.0f).MaxValue(8.0f).MinSliderValue(-1.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
							.Value_Lambda([this]() -> TOptional<float> { const FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); return Gen ? Gen->Offset : 0.0f; })
							.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask()) { Gen->Offset = Value; RefreshLayeredPreview(); } }),
							FSimpleDelegate::CreateLambda([this]() { if (FMixtormatGeneratedMask* Gen = GetSelectedGeneratedMask(); Gen && !FMath::IsNearlyEqual(Gen->Offset, 0.0f)) { Gen->Offset = 0.0f; RefreshLayeredPreview(); } }))
					]
				]
			]
		];
	...
	return SNew(SBox)
		...
		[
			...
			.HeaderAction(
				...
				[
					...
					.IsChecked_Lambda([this]() { const FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); return Mask && Mask->bEnabled ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; })
					.OnCheckStateChanged_Lambda([this](const ECheckBoxState State) { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask()) { Mask->bEnabled = State == ECheckBoxState::Checked; RefreshLayeredPreview(); RebuildLayerList(); } })
				])
			[
				SNew(SVerticalBox)
		...
		[
			...
			[
				...
				[
					SNew(SComboButton)
					.ButtonContent()[SNew(STextBlock).Text_Lambda([this]() { const FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); return Mask ? MixtormatUI::MaskBlendModeText(Mask->BlendMode) : FText::GetEmpty(); })]
			...
			[
				...
				[
					MakeResettableNumeric(
						...
						.SpinBoxStyle(&FMixtormatStyle::Get().GetWidgetStyle<FSpinBoxStyle>(TEXT("Mixtormat.ScrubControl")))
						.AllowSpin(true).MinValue(0.0f).MaxValue(1.0f).MinSliderValue(0.0f).MaxSliderValue(1.0f).Delta(0.01f).MinDesiredValueWidth(96.0f)
						.Value_Lambda([this]() -> TOptional<float> { const FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); return Mask ? Mask->Weight : 1.0f; })
						.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask()) { Mask->Weight = Value; RefreshLayeredPreview(); } }),
						FSimpleDelegate::CreateLambda([this]() { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); Mask && !FMath::IsNearlyEqual(Mask->Weight, 1.0f)) { Mask->Weight = 1.0f; RefreshLayeredPreview(); } }))
				]
			]
			+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
			[
				...
				[
					MakeResettableNumeric(
						...
						.Value_Lambda([this]() -> TOptional<int32> { const FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); return Mask ? Mask->Tiling : 1; })
						.OnValueChanged_Lambda([this](const int32 Value) { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask()) { Mask->Tiling = Value; RefreshLayeredPreview(); } }),
						FSimpleDelegate::CreateLambda([this]() { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); Mask && Mask->Tiling != 1) { Mask->Tiling = 1; RefreshLayeredPreview(); } }))
				]
			]
			+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
			[
				...
				[
					MakeResettableNumeric(
						...
						.Value_Lambda([this]() -> TOptional<float> { const FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); return Mask ? Mask->Balance : 0.5f; })
						.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask()) { Mask->Balance = Value; RefreshLayeredPreview(); } }),
						FSimpleDelegate::CreateLambda([this]() { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); Mask && !FMath::IsNearlyEqual(Mask->Balance, 0.5f)) { Mask->Balance = 0.5f; RefreshLayeredPreview(); } }))
				]
			]
			+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
			[
				...
				[
					MakeResettableNumeric(
						...
						.Value_Lambda([this]() -> TOptional<float> { const FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); return Mask ? Mask->Contrast : 1.0f; })
						.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask()) { Mask->Contrast = Value; RefreshLayeredPreview(); } }),
						FSimpleDelegate::CreateLambda([this]() { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); Mask && !FMath::IsNearlyEqual(Mask->Contrast, 1.0f)) { Mask->Contrast = 1.0f; RefreshLayeredPreview(); } }))
				]
			]
			+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
			[
				...
				[
					MakeResettableNumeric(
						...
						.Value_Lambda([this]() -> TOptional<float> { const FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); return Mask ? Mask->Offset : 0.0f; })
						.OnValueChanged_Lambda([this](const float Value) { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask()) { Mask->Offset = Value; RefreshLayeredPreview(); } }),
						FSimpleDelegate::CreateLambda([this]() { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); Mask && !FMath::IsNearlyZero(Mask->Offset)) { Mask->Offset = 0.0f; RefreshLayeredPreview(); } }))
				]
			]
			+ SVerticalBox::Slot().AutoHeight()
			[
				...
				[
					SNew(SCheckBox)
					.IsChecked_Lambda([this]() { const FMixtormatMaskLayer* Mask = GetSelectedLayerMask(); return Mask && Mask->bInvert ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; })
					.OnCheckStateChanged_Lambda([this](const ECheckBoxState State) { if (FMixtormatMaskLayer* Mask = GetSelectedLayerMask()) { Mask->bInvert = State == ECheckBoxState::Checked; RefreshLayeredPreview(); } })
				]
			]
...
TSharedRef<SWidget> SMixtormat::BuildSurfaceMaskInfluenceControls()
{
	const auto InfluenceRow = [this](
		const FText& Label,
		const FText& ToolTip,
		float FMixtormatLayer::* Member) -> TSharedRef<SWidget>
	{
	...
	const auto InvertRow = [this](
		const FText& Label,
		const FText& ToolTip,
		bool FMixtormatLayer::* Member) -> TSharedRef<SWidget>
	{
		return SNew(SHorizontalBox)
			+ SHorizontalBox::Slot().FillWidth(1.0f).VAlign(VAlign_Center)
			[
	...
	return SNew(SVerticalBox)
		...
		[
			InfluenceRow(
				...
				&FMixtormatLayer::HeightFeatureInfluence)
		]
		+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
		[
			InvertRow(
		...
		[
			InfluenceRow(
				...
				&FMixtormatLayer::AOFeatureInfluence)
		]
		+ SVerticalBox::Slot().AutoHeight()
		[
			InvertRow(
	...
	return SNew(SBox)
		...
		[
			...
			[
				SNew(SVerticalBox)
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[NumericRow(LOCTEXT("BaseColorInfluenceLabel", "Base Color"), &FMixtormatLayer::BaseColorInfluence)]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[NumericRow(LOCTEXT("RoughnessInfluenceLabel", "Roughness"), &FMixtormatLayer::RoughnessInfluence)]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[NumericRow(LOCTEXT("AOInfluenceLabel", "Ambient Occlusion"), &FMixtormatLayer::AOInfluence)]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[NumericRow(LOCTEXT("MetallicInfluenceLabel", "Metallic"), &FMixtormatLayer::MetallicInfluence)]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[NumericRow(LOCTEXT("F0InfluenceLabel", "IOR / F0"), &FMixtormatLayer::F0Influence)]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[NumericRow(LOCTEXT("LayerNormalInfluenceLabel", "Normal"), &FMixtormatLayer::NormalInfluence)]
				+ SVerticalBox::Slot().AutoHeight()
				[NumericRow(LOCTEXT("LayerHeightInfluenceLabel", "Height"), &FMixtormatLayer::HeightInfluence)]
			]
		];
}
	...
	return SNew(SBox)
		...
		[
			...
			[
				...
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					NumericRow(LOCTEXT("HueShiftLabel", "Hue Shift"), &FMixtormatLayer::HueShift, -180.0f, 180.0f, 0.01f, 0.0f)
				]
				+ SVerticalBox::Slot().AutoHeight().Padding(0.0f, 0.0f, 0.0f, 3.0f)
				[
					NumericRow(LOCTEXT("SaturationLabel", "Saturation"), &FMixtormatLayer::Saturation, 0.0f, 2.0f, 0.01f, 1.0f)
				]
				+ SVerticalBox::Slot().AutoHeight()
				[
					NumericRow(LOCTEXT("ValueLabel", "Value"), &FMixtormatLayer::Value, 0.0f, 2.0f, 0.01f, 1.0f)
				]
			]
		];
}
...
TSharedRef<SWidget> SMixtormat::BuildEffectInspectorControls()
{
	...
	AddFloatControl(Panel, LOCTEXT("PeelingBias", "Bias / Front"), &FMixtormatLayerEffect::Front, 0.0f, 1.0f, 0.005f, 0.08f);
