...
namespace MixtormatNormalHeightTests
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMixtormatNormalDerivedHeightTest,
	"Mixtormat.Import.NormalDerivedHeight",
	EAutomationTestFlags::EditorContext
		| EAutomationTestFlags::EngineFilter
		| EAutomationTestFlags::NonNullRHI)

bool FMixtormatNormalDerivedHeightTest::RunTest(const FString& Parameters)
{
	using namespace MixtormatNormalHeightTests;
	(void)Parameters;
	...
	TestTrue(
		...
		FMixtormatNormalHeightGenerator::Generate(
			FlatPixels,
