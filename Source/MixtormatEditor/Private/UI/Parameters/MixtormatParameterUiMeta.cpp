	...
	const TArray<FUiMetaRow>& UiMetaRows()
	{
		static const TArray<FUiMetaRow> Rows = []()
		{
			return TArray<FUiMetaRow>({
				...
				{TEXT("BreakupStretch"), {0.05f, 4.0f, 0.01f,
					TEXT("The shader divides by stretch, so below 1 (vertical elongation) is legal. The old compositor floor of 1.0 was a design choice, not math.")}},
