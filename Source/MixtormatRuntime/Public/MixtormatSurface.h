...
#include "MixtormatSurface.generated.h"

class UMaterialInterface;
class UTexture2D;

UENUM(BlueprintType)
enum class EMixtormatBlendHeightProvenance : uint8
{
...
class MIXTORMATRUNTIME_API UMixtormatSurface final : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Textures")
	EMixtormatBlendHeightProvenance BlendHeightProvenance =
