	...
	const TArray<FMixtormatParameterDefinition>& Definitions()
	{
		static const TArray<FMixtormatParameterDefinition> Table = []()
		{
			...
			return TArray<FMixtormatParameterDefinition>({
				...
				{ET::Effect, TEXT("BreakupScale"), VT::Int, 6.0f, 1.0f, 64.0f},
				{ET::Effect, TEXT("BreakupDensity"), VT::Float, 0.72f, {}, {}, 1.0f, true},
				// Size feeds the shape metric's radius; zero or negative cannot exist as a piece.
				{ET::Effect, TEXT("BreakupSize"), VT::Float, 0.32f, 0.001f, {}},
				// Stretch divides (sy = radius / stretch); the old compositor's >= 1 floor was
				// design, not safety -- below 1 is a legal vertical elongation.
				{ET::Effect, TEXT("BreakupStretch"), VT::Float, 1.6f, 0.001f, {}},
				{ET::Effect, TEXT("BreakupAngularity"), VT::Float, 0.72f, {}, {}, 1.0f, true},
				{ET::Effect, TEXT("BreakupIrregularity"), VT::Float, 0.38f},
				{ET::Effect, TEXT("BreakupInset"), VT::Float, 0.0f},
				{ET::Effect, TEXT("BreakupDistortion"), VT::Float, 5.6f},
				// Integer-period sinusoid frequency; 0 has no period.
				{ET::Effect, TEXT("BreakupDistortionFrequency"), VT::Int, 3.0f, 1.0f, 16.0f},

				// Structure.
				{ET::Effect, TEXT("BreakupRelief"), VT::Float, -0.06f},
				{ET::Effect, TEXT("BreakupThicknessVariation"), VT::Float, 0.30f},
				{ET::Effect, TEXT("BreakupGapWidth"), VT::Float, 2.0f, 0.0f, {}},
				{ET::Effect, TEXT("BreakupGapDepth"), VT::Float, 0.02f},
				{ET::Effect, TEXT("BreakupGapVariation"), VT::Float, 0.35f},
				{ET::Effect, TEXT("BreakupFold"), VT::Float, 0.025f},
				// Widths reach divisors in the falloff math.
				{ET::Effect, TEXT("BreakupFoldWidth"), VT::Float, 16.0f, DivisorFloor, {}},
				{ET::Effect, TEXT("BreakupCrease"), VT::Float, 0.018f},
				{ET::Effect, TEXT("BreakupCreaseWidth"), VT::Float, 1.25f, DivisorFloor, {}},
				{ET::Effect, TEXT("BreakupPush"), VT::Float, 0.0f},
				{ET::Effect, TEXT("BreakupPushWidth"), VT::Float, 24.0f, DivisorFloor, {}},
				{ET::Effect, TEXT("BreakupPushRelief"), VT::Float, 0.035f, 0.0f, {}},

				// Variation. The shader saturates Variation itself.
				{ET::Effect, TEXT("BreakupDetail"), VT::Float, 0.5f},
				{ET::Effect, TEXT("BreakupVariation"), VT::Float, 0.25f, {}, {}, 1.0f, true},

				// Shading.
				{ET::Effect, TEXT("BreakupAmount"), VT::Float, 1.0f, {}, {}, 1.0f, true},
				// The channel result saturates after the signed offset, so any magnitude is legal.
				{ET::Effect, TEXT("BreakupRoughnessAmount"), VT::Float, 0.0f, {}, {}, 1.0f, true},
				{ET::Effect, TEXT("BreakupNormalStrength"), VT::Float, 2.0f, 0.0f, {}},
				{ET::Effect, TEXT("BreakupNormalSharpness"), VT::Float, 0.75f, {}, {}, 1.0f, true},
				{ET::Effect, TEXT("BreakupAOAmount"), VT::Float, 0.35f, {}, {}, 1.0f, true},
				// AO radius divides in the occlusion falloff.
				{ET::Effect, TEXT("BreakupAORadius"), VT::Float, 8.0f, 1.0f, {}},

				// Placement.
				{ET::Effect, TEXT("BreakupMaskTiling"), VT::Int, 1.0f, 1.0f, {}},
				{ET::Effect, TEXT("BreakupSeed"), VT::Int, 1.0f, 0.0f, {}},
			});
		}();
